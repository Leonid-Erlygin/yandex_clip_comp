...
class I2TDataset(Dataset):
    def __init__(self, data: list, images_directory, model_path):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        #return {"image": img, "text": self.tokenizer(text, padding=True, truncation=True, return_tensors='pt')}
...
def get_dataloaders(
    ...
    train_dataset = I2TDataset(data_train, images_directory, model_path)
